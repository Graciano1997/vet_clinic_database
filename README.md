...
- [coming](<replace-with-your-deployment-URL>)
...
```sh
  cd my-folder
  git clone https://github.com/Graciano1997/vet_clinic_database.git
```
-
...
```sh
  copy the schema.sql scripts and run in Query tool 
  copy the data.sql scripts and run in Query tool 
  copy the queries.sql scripts and run in Query tool 
```
<p align="right">(<a href="#readme-top">back to top</a>)</p>
